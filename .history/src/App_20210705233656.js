...
const App = () => {
  ...
  useEffect(() => {
    // const data = new RandExp(/^(([1-9]|\.)+|\W+)$/g).gen();
    const STRING_BOARD_LENGTH = 81;
    const emptySudokuString = ".".repeat(STRING_BOARD_LENGTH);
    console.log(emptySudokuString);
  }, []);
